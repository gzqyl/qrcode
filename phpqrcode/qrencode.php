 ...
 */
    ...
    class QRcode {
        ...
        //--------------------------logo --------------------------------------------
        public static function logo($text, $outfile = false, $level = QR_ECLEVEL_L, $size = 3, $margin = 4, $saveandprint=false, $back_color = 0xFFFFFF, $fore_color = 0x000000,$logo) 
        {
            $enc = QRencode::factory($level, $size, $margin, $back_color, $fore_color);
            return $enc->encodeLogo($text, $outfile, $saveandprint=false,$logo);
        }
    ...
    class QRencode {
        ...
        //-----------------encode LOGO-----------------------------------------------------
        public function encodeLogo($intext, $outfile = false,$saveandprint=false,$logo) 
        {
            try {
